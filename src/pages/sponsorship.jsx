    ...
    return (
      <Layout color='mint'>
        <ScrollLink to="page" spy={true} smooth={true} duration={320}>
          <Hero color='mint' images={sponsorship.data.background.localFile.childImageSharp.fluid}>
        ...
        <ScrollElement name='page'>
          <Section flexible>
            <Thirds>
              <ThirdCol>
                <PaddedCol>
                  <StandardIcon><Cocktail style={{width: '100%'}} /></StandardIcon>
                  <SimpleHeader>VIP experience</SimpleHeader>
                  <Heading size={4} color='black' bg='white' text='Gold-standard experience across our trips abroad and in the UK.' />              
                </PaddedCol>
              </ThirdCol>
              <ThirdCol>
                <PaddedCol>
                  <StandardIcon><Lightbulb style={{width: '100%'}} /></StandardIcon>
                  <SimpleHeader>Excellence on tap</SimpleHeader>
                  <Heading size={4} color='black' bg='white' text='Direct contact with the greatest entrepreneurs and founders in the tech space.' />              
                </PaddedCol>
              </ThirdCol>
              <ThirdCol>
                <PaddedCol>
                  <StandardIcon><Megaphone style={{width: '100%'}} /></StandardIcon>
                  <SimpleHeader>Brand exposure</SimpleHeader>
                  <Heading size={4} color='black' bg='white' text='Your company championed, doing great stuff for UK innovation at large.' />              
                </PaddedCol>
              </ThirdCol>
            </Thirds>            
          </Section>
          ...
          <Section bg='white' color='black'>
            ...
            <Heading size={1} color='white' bg='mint' text='Your ideas, front and centre' />
