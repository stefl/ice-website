      ...
      <Layout color="sky">
        ...
        <ScrollElement name="page">
          ...
          <Section color="black" bg="sky">
            ...
            <Narrow>
              <p>
                Forging strong bonds, supporting through the good and bad,
                making amazing memories. We’re not here to network, we’re here
                to find our people.
              </p>
            </Narrow>
          </Section>
          ...
          <Section bg="black" color="white" flexible>
            ...
            <Narrow>
              <p>
                We’re at our best when we’re together. So we make sure that
                we’re together as much as possible.
              </p>
              <p>
          ...
          <Section bg="white" color="black">
            ...
            <Narrow>
              ...
              <p>
                ...
                people who have your back, without any pressure. An
                entrepreneur’s journey can be lonely. We decided to change that.
              </p>
            </Narrow>
          </Section>
          ...
          <Section bg="black" color="white" flexible>
            ...
            <Narrow>
              <p>
                It absolutely doesn’t. ICE is run by an amazing group who give
                up their time and talent because they believe in what we’re
                doing here. And they do it for free. The beautiful maniacs.
              </p>
            </Narrow>
          ...
          <Section bg="sky" color="black">
            ...
            <Narrow>
              ...
              <p>
                If you reckon you’ve got the good opinion of two people we
                already trust, hit apply. We want to know more about you.{' '}
              </p>
              <StandardIcon>
